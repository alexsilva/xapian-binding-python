...
subclass as shown here:http://trac.xapian.org/ticket/554#comment:1
...
AND, OR, XOR, ELITE_SET, SYNONYM, NEAR and PHRASE can take any number
of subqueries. Other operators take exactly two subqueries.
...
exclusive:  If true, each document can have at most one term with this
prefix, so multiple filters with this prefix should be combined with
OP_OR. If false, each document can have multiple terms with this
prefix, so multiple filters should be combined with OP_AND, like
happens with filters with different prefixes. [default: true] ";
...
// File: dir_168225033f613bf58e19d0630bef5c8b.xml


// File: dir_3c504f51550cb9fcc49223adf2dc9606.xml
